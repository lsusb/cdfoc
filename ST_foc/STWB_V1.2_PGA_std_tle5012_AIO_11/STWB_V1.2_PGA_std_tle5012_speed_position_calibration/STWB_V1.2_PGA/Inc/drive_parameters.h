...
#define MAX_APPLICATION_SPEED_RPM       2388 /*!< rpm, mechanical */
...
#define PLL_KP_GAIN                      699
#define PLL_KI_GAIN                      24
...
#define PID_TORQUE_KP_DEFAULT         3816
#define PID_TORQUE_KI_DEFAULT         3816
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           250
#define PID_FLUX_KI_DEFAULT           250
...
#define PID_SPEED_KP_DEFAULT          2588/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          169/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define PHASE1_FINAL_CURRENT           3178
/* Phase 2 */
#define PHASE2_DURATION                1968 /*milliseconds */
#define PHASE2_FINAL_SPEED_UNIT         (984*SPEED_UNIT/_RPM)
#define PHASE2_FINAL_CURRENT           3178
/* Phase 3 */
#define PHASE3_DURATION                0 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT         (984*SPEED_UNIT/_RPM)
#define PHASE3_FINAL_CURRENT           3178
/* Phase 4 */
#define PHASE4_DURATION                0 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT         (984*SPEED_UNIT/_RPM)
#define PHASE4_FINAL_CURRENT           3178
/* Phase 5 */
#define PHASE5_DURATION                0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT         (984*SPEED_UNIT/_RPM)
#define PHASE5_FINAL_CURRENT           3178

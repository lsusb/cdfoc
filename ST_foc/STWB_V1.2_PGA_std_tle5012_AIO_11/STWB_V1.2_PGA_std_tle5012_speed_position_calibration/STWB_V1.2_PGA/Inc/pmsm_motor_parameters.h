...
#define RS                     2.41 /* Stator resistance , ohm*/
#define LS                     0.000241 /* Stator inductance, H
...
#define NOMINAL_CURRENT         3178
#define MOTOR_MAX_SPEED_RPM     2388 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  6.9 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -3178 /*!< Demagnetization current */

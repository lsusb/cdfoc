...
GCC_PATH="E:/WORK_FILES/STM32 FOR VSCODE/GCC-ARM-NONE-EABI-10.3-2021.10-WIN32/GCC-ARM-NONE-EABI-10.3-2021.10/BIN
ifdef GCC_PATH
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"E:/WORK_FILES/STM32 FOR VSCODE/OPENOCD-20231002/OPENOCD-20231002-0.12.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"E:/WORK_FILES/STM32 FOR VSCODE/OPENOCD-20231002/OPENOCD-20231002-0.12.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "init; reset halt; stm32g4x mass_erase 0; exit"
